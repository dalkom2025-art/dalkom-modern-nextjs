...
export default async function Home() {
  ...
  return (
    <SiteChrome>
      <main>
        <section
          className="relative min-h-[calc(100vh-170px)] overflow-hidden rounded-3xl border border-white/10 p-8 sm:p-10"
          style={{
            backgroundImage:
              "linear-gradient(rgba(2,6,23,0.22), rgba(2,6,23,0.32)), url('/images/hero-bg.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <div className="relative flex min-h-[calc(100vh-250px)] flex-col justify-end">
            <div>
            ...
            <section className="mt-8 grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <Link href="/news" className="block rounded-2xl border border-white/20 bg-black/30 p-5 backdrop-blur-sm transition hover:bg-black/40">
              ...
              <div>
                ...
                <Link href="/images" className="block rounded-2xl border border-white/20 bg-black/30 p-5 backdrop-blur-sm transition hover:bg-black/40">
